...
int main(){
    ...
    average=(maths+science+english)/3.0f;
    if(average>=90.0f)
        printf("Grade A\n");
...
```
# Output:
<img width="658" height="256" alt="image" src="https://github.com/user-attachments/assets/47270058-dc98-494a-8687-6e1f62fb5fea" />
...
```
# Output:
<img width="461" height="432" alt="image" src="https://github.com/user-attachments/assets/3fd85a17-73aa-4607-b964-505bf4914823" />
...
```
# Output:
<img width="525" height="265" alt="image" src="https://github.com/user-attachments/assets/f199cb6c-fc63-4062-aede-3fe306179a45" />
...
```
# Output:
<img width="558" height="310" alt="image" src="https://github.com/user-attachments/assets/9863ccdc-c385-47ef-b357-79ceaae183f1" />
...
```
## Output:
<img width="519" height="406" alt="image" src="https://github.com/user-attachments/assets/c2c07079-ee59-405c-b52d-c4fed6f8daac" />
